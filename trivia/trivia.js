...
function Trivia() {
  ...
  var ctsec = 10;         // number of seconds for each quiz
...
var files_xml = {'Milestones':'milestones.xml', 'Trades':'trades.xml', 'Captains' : 'captains.xml'};
